...
with open('Marking Details.csv') as STUDENT.csv:
    csv_reader_1 = csv.DictReader(STUDENT.csv)
    grades = []
...
# Starting to work on Marking Details.csv:
with open('Marking Details.csv') as COURSE.csv:
    csv_reader_2 = csv.DictReader(COURSE.csv)
    nameing = []
    marking = []
...
with open('Batch Details.csv') as BATCH.csv:
    csv_reader_3 = csv.DictReader(BATCH.csv)
    batch = []
    avg_percent = []
...
# Starting to work on Marking Details.csv:
with open('Marking Details.csv') as DEPARTMENT.csv:
    csv_reader_4 = csv.DictReader(DEPARTMENT.csv)
    marking_1 = []
...
# Starting to work on Student Details.csv:
with open('Student Details.csv') as STUDENT.csv:
    csv_reader_1 = csv.DictReader(STUDENT.csv)
    for row in csv_reader_1:
...
# Starting to work on Marking Details.csv:
with open('Marking Details.csv') as COURSE.csv:
    csv_reader_2 = csv.DictReader(COURSE)
    for row in csv_reader_2:
...
with open('Course Details.csv') as DEPARTMENT.csv:
    csv_reader_4 = csv.DictReader(DEPARTMENT.csv)
    for row in csv_reader_4:
